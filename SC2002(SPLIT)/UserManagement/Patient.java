...
public class Patient extends Users implements Schedulable, PaymentProcessor {
    ...
    // System.out.print(
    // "Invalid contact number. It should start with 8 or 9 and have 8 digits.
    // Please try again: ");
    ...
    // try {
    // boolean updated = patientManager.updatePatientData(getUserID(), newEmail,
    // newContact);
    // if (updated) {
    // System.out.println("Contact information updated successfully in all
    // records.");
    // } else {
